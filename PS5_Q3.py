...
# Set Database Path (데이터베이스 경로 설정)
db_path = "/blue/bsc4452/seoyeon0814/problem_set5/world.sqlite"  # 경로 수정
connection = sqlite3.connect(db_path)
cursor = connection.cursor()

# Add data for two cities in South Sudan (South Sudan의 두 도시 데이터 추가)
try:
    # Check Existing Data (기존 데이터 확인)
    ...
    if len(existing_cities) > 0:
        ...
        # Execute SQL INSERT (SQL INSERT 실행)
        sql_insert = """
